...
public:
  ...
  std::pair<float,float> scaleFactorRecoTrkQual(float eta, float ET=20000., int range=0, int rel=4, bool etcorrection=false) { return scaleFactor(eta, ET, 4, range, rel, etcorrection); };
