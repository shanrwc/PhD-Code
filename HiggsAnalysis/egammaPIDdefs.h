...
namespace egammaPID { 
 ...
 /*! \enum Bitdefinitons for the egamma identification tools */
  ...
  const unsigned int ElectronLoose = 
    CALOMIDDLE_ELECTRON | HADLEAKETA_ELECTRON;
  /** @brief Medium electron selection (in rel 16.0.0 the deltaEta cut has been removed wrt rel 15.6.X) */
  ...
  /** @brief Tight electron (corresponds to RobusterTight in 15.6.X but without the deltaEta bits
