...
int egammaOQ::checkOQClusterElectron(int runnumber, double myEta, double myPhi, bool syst, bool verbose) {
...
int egammaOQ::checkOQClusterPhoton(int runnumber, double myEta, double myPhi, bool conv, bool syst, bool verbose) {
...
int egammaOQ::checkOQCluster(int runnumber, double myEta, double myPhi, int candidate, bool syst, bool verbose) {
...
//
int egammaOQ::deadRegionS2(double myEta, double myPhi, double deltaEta, double deltaPhi, int candidate, bool verbose){
