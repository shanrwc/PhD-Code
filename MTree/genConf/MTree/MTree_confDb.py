##  -*- python -*-  
# db file automatically generated by genconf on: Fri Oct  7 15:28:29 2011
...
def _fillCfgDb():
    ...
    cfgDb.add( configurable = 'ConvertAODToMTree',
               package = 'MTree',
               module  = 'MTree.MTreeConf',
               lib     = 'MTree' )
    return #_fillCfgDb
...
try:
    ...
    print "Py:ConfigurableDb   ERROR   ==> culprit is package [MTree] !"
